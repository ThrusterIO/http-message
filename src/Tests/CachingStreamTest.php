...
use Thruster\Component\HttpMessage\CachingStream;
use Thruster\Component\HttpMessage\FnStream;
use function Thruster\Component\HttpMessage\stream_for;
use function Thruster\Component\HttpMessage\readline;
 ...
 */
class CachingStreamTestt extends \PHPUnit_Framework_TestCase
{
    /**
     * @var CachingStream
     */
    ...
    {
        $this->decorated = stream_for('testing');
    ...
    {
        $baseStream = stream_for(implode('', range('a', 'z')));
    ...
    public function testRewindUsesSeek()
    {
        ...
        $d = $this->getMockBuilder('Thruster\Component\HttpMessage\CachingStream')

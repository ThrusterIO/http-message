...
class LimitStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->decorated = stream_for(fopen(__FILE__, 'r'));
        $this->body      = new LimitStream($this->decorated, 10, 3);
    }

    public function testReturnsSubset()
    {
        $body = new LimitStream(stream_for('foo'), -1, 1);
    ...
    {
        new LimitStream(stream_for(''), 0, 10);
    }

    public function testReturnsSubsetOfEmptyBodyWhenCastToString()
    {
        $body    = stream_for('01234567891234');
    ...
    {
        $body    = stream_for('0123456789abcdef');
    ...
    {
        $body = new LimitStream(stream_for('foobazbar'), 3, 3);
